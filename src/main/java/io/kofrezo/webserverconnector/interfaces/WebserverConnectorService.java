 ...
 * 
 * Interface to offer setup a standard way to setup several concrete webservers
...
{    
     ...
     * 
     * Check if the current connector object is setup correct to execute the
     * standard commands.
     * 
     * @return 
     */
     ...
     * 
     * All occurrences of the String %DOMAIN% in template file are replaced 
     * with the domain name given. Should do nothing if the virtual host 
     * already exists. Should not enable the new virtual host.
     * 
     * @param domain
     * @param aliases 
     */
     ...
     * 
     * Deletes the existing virtual host for the given domain. Should do 
     * nothing if the virtual host does not exist.
     * 
     * @param domain 
     */
     ...
     * 
     * Enables an existing virtual host matching the given domain name. Should
     * do nothing if the virtual host does not exist.
     * 
     * @param domain 
     */
     ...
     * 
     * Disables an existing virtual host matching the given domain name. Should
     * do nothing if the virtual host does not exist.
     * 
     * @param domain 
     */
     ...
     * 
     * Set additional credentials for authentication a concrete implementation
     * my need.
     * 
     * @param credentials 
     */
